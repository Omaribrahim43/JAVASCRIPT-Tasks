...
conEmail.onkeyup = () => {
    ...
    if(conEmail.value != email.value){
        document.getElementById("c-email-message").innerHTML = 'it does not match the email given.';
    } else if(!regex.test(conEmail.value)){
        document.getElementById("c-email-message").innerHTML = 'Invalid email given.';
    } else{
...
pass.onkeyup = () => {
    ...
    if(!regex.test(pass.value)){
        document.getElementById("pass-message").innerHTML = 'Invalid password given.';
    } else{
...
conPass.onkeyup = () => {
    ...
    if(conPass.value != pass.value){
        document.getElementById("c-pass-message").innerHTML = 'it does not match the password given.';
    } else if(!regex.test(conPass.value)){
        document.getElementById("c-pass-message").innerHTML = 'Invalid password given.';
    } else{
        document.getElementById("c-pass-message").innerHTML = 'Valid password given.';
    }
}