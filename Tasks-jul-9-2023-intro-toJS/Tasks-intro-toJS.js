...
let zakat = 0;
zakat = x % 2.5;
document.getElementById("answer-task1").innerHTML =
  "the zakat of a 250JDs is = " + zakat + "JDs";
...
document.getElementById("answer-task2").innerHTML =
  "The Correct the syntax for the first array is [1, 7, 9, 45] <br> and The Correct the syntax for the second array is  ['Str', 'alex','moh', 'the','fox', 'over', 'lazy', 'dog']";
...
document.getElementById("answer-task3").innerHTML =
  "The index of Banana is " +
  fruits.indexOf("Banana") +
  "The index of Tomato is " +
...
let arr1 = [1, 4, 5];
let arr2 = ["t", "u", "g", "x"];
document.getElementById("answer-task5").innerHTML =
  "the first element in [1,4,5] is " +
  arr1[0] +
  " the first element in ['t','u','g','x'] is " +
  arr2[0];
...
let arr3 = [1, 4, 5];
let arr4 = ["t", "u", "g", "x"];
document.getElementById("answer-task6").innerHTML =
  "the first element in [1,4,5] is " +
  arr3[arr3.length - 1] +
  " the first element in ['t','u','g','x'] is " +
  arr4[arr4.length - 1];
